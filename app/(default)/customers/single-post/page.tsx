...
export const metadata = {
  title: 'Případová studie zákazníka Verbosus',
  description:
    'Přečtěte si detailní případovou studii o tom, jak klienti využívají AI marketingového agenta Verbosus pro onboarding a růst.',
  alternates: {
    canonical: '/customers/single-post/',
  },
} satisfies Metadata;
